...
class PalavraSignificado {
	...
	string significado;
public:
	PalavraSignificado(string p, string s) :
			palavra(p), significado(s) {
	}
	string getPalavra() {
		return palavra;
	}
	...
	void setSignificado(string sig) {
		significado = sig;
	}
